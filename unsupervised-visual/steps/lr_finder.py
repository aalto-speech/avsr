...
class LRFinder(object):
    ...
    def __init__(self, image_model, audio_model, optimizer, criterion, device=None, memory_cache=True, cache_dir=None):
        ...
        # needed
        self.model_device = next(self.image_model.parameters()).device
        self.state_cacher = StateCacher(memory_cache, cache_dir=cache_dir)
        self.state_cacher.store('image_model', self.image_model.state_dict())
        self.state_cacher.store('audio_model', self.audio_model.state_dict())
    ...
    def reset(self):
        ...
        self.image_model.load_state_dict(self.state_cacher.retrieve('model'))
        self.audio_model.load_state_dict(self.state_cacher.retrieve('model'))
        self.optimizer.load_state_dict(self.state_cacher.retrieve('optimizer'))
        self.image_model.to(self.model_device)
        self.audio_model.to(self.model_device)
    ...
    def range_test(
        ...
        Arguments:
            ...
            val_loader (torch.utils.data.DataLoader, optional): if `None` the range test
                ...
                evaluated after each iteration on that data set and the evaluation loss
